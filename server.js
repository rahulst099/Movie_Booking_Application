...
async function init() {
  ...
  try {
    user = await User.create({
      ...
      email: "rahulst099@gmail.com", // If we don't pass this, it will throw the error
      userType: "ADMIN",
  ...
  try {
    client1 = await User.create({
      ...
      email: "rahulsh1@gmail.com", // If we don't pass this, it will throw the error
      userType: "CLIENT",
      password: bcrypt.hashSync("Welcome1", 8), //this field should be hidden from the end user
    });
    client2 = await User.create({
      ...
      email: "rahulsh2@gmail.com", // If we don't pass this, it will throw the error
      userType: "CLIENT",
      password: bcrypt.hashSync("Welcome1", 8), //this field should be hidden from the end user
    });
    client3 = await User.create({
      ...
      email: "rahulsh3@gmail.com", // If we don't pass this, it will throw the error
      userType: "CLIENT",
      password: bcrypt.hashSync("Welcome1", 8), //this field should be hidden from the end user
    });
